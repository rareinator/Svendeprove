...
namespace DataAccessLibrary
{
    public interface IJournalData
    {
        // JOURNAL
        /// <summary>
        /// Sends a GET request to endpoint "/journal/byPatient/{param} to get journals by the specified patient 
        /// </summary>
        ...
        /// <summary>
        /// Sends a POST request to endpoint "/journal" with {param} in the request body to add a new journal to a patient  
        /// </summary>
        ...
        /// <summary>
        /// Sends a GET request to endpoint "/journal/document/byJournal/{param} to get journal documents by specified id of a existing journal
        /// </summary>
        ...
        /// <summary>
        /// Sends a GET request to endpoint "/journal/document/{param} to get a journal document by specified id of a existing journal document
        /// </summary>
        ...
        /// <summary>
        /// Sends a POST request to endpoint "/journal/document/{param.DocumentId} with {param} in the request body to edit a existing journal document
        /// </summary>
        /// <param name="document"></param>
