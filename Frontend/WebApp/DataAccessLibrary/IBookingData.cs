...
namespace DataAccessLibrary
{
    ...
    {
        /// <summary>
        /// Sends a GET request to endpoint "/booking/byPatient/{param} to get bookings by the specified patient 
        /// </summary>
        ...
        /// <summary>
        /// Sends a GET request to endpoint "/booking/byEmployee/{param} to get bookings by the specified employee attending in the booking 
        /// </summary>
        ...
        /// <summary>
        /// Sends a GET request to endpoint "/admin/hospitals to get all hospitals
        /// </summary>
        /// <returns>List of hospital objects</returns>
        Task<List<HospitalModel>> GetHospitals();

        /// <summary>
        /// Sends a GET request to endpoint "/admin/doctors/inHospital/{param} to get available employees in specified hospital by id
        /// </summary>
        ...
        /// <summary>
        /// Sends a POST request to endpoint "/booking/availableTimesForDoctor with {param} in the request body to get all available times for specified employee and day
        /// </summary>
        ...
        /// <summary>
        /// Sends a POST request to endpoint "/admin/availableBeds with {param} in the request body to get all available beds for specified hospitalId and timeframe
        /// </summary>
        /// <param name="data"></param>
