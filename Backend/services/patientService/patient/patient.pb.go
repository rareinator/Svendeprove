...
var file_patient_proto_rawDesc = []byte{
	...
	0x02, 0x49, 0x64, 0x32, 0xff, 0x01, 0x0a, 0x0e, 0x50, 0x61, 0x74, 0x69, 0x65, 0x6e, 0x74, 0x53,
	...
	0x75, 0x73, 0x22, 0x00, 0x12, 0x2f, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x50, 0x61, 0x74, 0x69, 0x65,
	0x6e, 0x74, 0x73, 0x42, 0x79, 0x48, 0x6f, 0x73, 0x70, 0x69, 0x74, 0x61, 0x6c, 0x12, 0x09, 0x2e,
	0x50, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x09, 0x2e, 0x50, 0x61, 0x74, 0x69, 0x65,
	0x6e, 0x74, 0x73, 0x22, 0x00, 0x42, 0x0b, 0x5a, 0x09, 0x2e, 0x3b, 0x70, 0x61, 0x74, 0x69, 0x65,
...
var file_patient_proto_depIdxs = []int32{
	...
	5, // 6: PatientService.GetPatientsByHospital:input_type -> PRequest
	1, // 7: PatientService.GetHealth:output_type -> PHealth
	3, // 8: PatientService.CreatePatient:output_type -> Patient
	3, // 9: PatientService.ReadPatient:output_type -> Patient
	3, // 10: PatientService.UpdatePatient:output_type -> Patient
	2, // 11: PatientService.DeletePatient:output_type -> PStatus
	4, // 12: PatientService.GetPatientsByHospital:output_type -> Patients
